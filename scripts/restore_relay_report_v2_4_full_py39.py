...
# -*- coding: utf-8 -*-
"""
restore_relay_report_v2_4_full_py39.py
Python 3.9対応:
- Path.write_text(newline=...) は使わず open(..., newline="\n") を使う
- relay_report_generator_ai_v2_4.py を完全に安全版へ書き戻す（自己改変を根絶）
"""
...
# Main PDF generation
# ==============================
def create_pdf(csv_path: str, title: str, out_pdf: str = None):
